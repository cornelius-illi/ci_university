...
class Tx_CiUniversity_Utility_AjaxDispatcher { 
    /**
    ...
    protected function prepareCallArguments() {
        ...
        $this->arguments['ajax'] = 1; // this way the controller knows the difference
...
$dispatcher = t3lib_div::makeInstance('Tx_CiUniversity_Utility_AjaxDispatcher');
$dispatcher->dispatch();
